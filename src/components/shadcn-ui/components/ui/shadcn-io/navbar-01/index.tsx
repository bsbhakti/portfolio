...
import {
  ...
  NavigationMenuLink,
  NavigationMenuList,
} from "@/components/shadcn-ui/components/ui/navigation-menu";
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
} from "@/components/shadcn-ui/components/ui/popover";
...
const defaultNavigationLinks: Navbar01NavLink[] = [
  ...
  { href: "#Connect", label: "Connect", active: true },
];
                    ...
                    {navigationLinks.map((link, index) => (
                      <NavigationMenuItem key={index}>
                        <a
                          href={link.href}
                          className={cn(
                            "group inline-flex h-9 w-max items-center justify-center rounded-md px-4 py-2 text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground no-underline",
                            link.active
                              ? "bg-accent text-accent-foreground"
